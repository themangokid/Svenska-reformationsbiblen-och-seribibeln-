...
\noindent
\begin{center}
\definecolor{verydarkbrown}{RGB}{33, 16, 0} % Even darker brown
\renewcommand{\labelitemi}{\textcolor{verydarkbrown}{\textbullet}}

{\fontsize{20}{24}\selectfont \color{titlecolor} {\textbf{Länkar}}}\\
% \textcolor{titlecolor}{\textbf{Länkar}}
\vspace{0.5em}
\begin{multicols}{2}
...
\begin{itemize}
  ...
  \item \href{https://bibel.se/}{Bibel.se}
  \item  \href{https://drive.google.com/drive/folders/1N-suLiCB4gOavhUg04P0xGzSDlCSntgo}{Samlat material}
  \item \href{https://bibel.se/wordpress/index.php/2022/01/18/oversatta-bibelbocker/}{SRB~Bibelböcker}
  % -- Next column
  \item \href{https://seriebibeln.com/kristna-serier}{Seriebibeln}
  \item \href{https://bibelonline.se/biblereader.php}{Bibelonline}
  \item \href{https://bibel.se/wordpress/index.php/2022/01/22/bestalla-reformationsbibeln/}{Köp SRB-Bibeln}
...
%\subsection*{Innehållsförteckning}
